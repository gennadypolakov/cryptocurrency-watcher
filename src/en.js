export const translation = {
  ...
  levelNotifications: 'Notify about levels',
  priceDistance: 'Level distance',
  priceDistanceDesc: 'The minimum distance from the current price to the nearest level in percent of the price for the notification to be triggered',
  ...
  orderNotifications: 'Notify about orders',
  orderPriceDistance: 'Order distance',
  orderPriceDistanceDesc: 'The minimum distance from the order price to the best price in percent of the price for the notification to be triggered',
  minOrderPercentage: 'Order size',
  ...
  highVolumeNotifications: 'Notify about high volumes',
  averageVolumeMultiplier: 'High volume multiplier',
