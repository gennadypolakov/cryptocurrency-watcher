...
export const orderPriceDistance = 0.01; // расстояние от ордера до лучшей цены в процентах от цены
export const minOrderPercentage = 1.5; // доля от среднего 5-минутного объема
export const orderTimeout = 1; // количество минут, по истечение которых заявка отобразится на графике
...
export const hourlyDelta = 12; // минимальное количество часовых свечей между часовыми уровнями
export const fourHoursDelta = 12; // минимальное количество 4-х часовых свечей между 4-х часовыми уровнями
export const dailyDelta = 12; // минимальное количество дневных свечей между дневными уровнями
